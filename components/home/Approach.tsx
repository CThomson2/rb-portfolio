  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        <span className="text-purple">High Purity</span> Grades
      </h1>
      <div className="my-20 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        {gradeInfo.map((grade) => (
          <Card
            key={grade.id}
            title={grade.title}
            icon={<AceternityIcon grade={grade.acronym} />}
            desc={grade.description}
          >
            <CanvasRevealEffect
              animationSpeed={grade.animationSpeed}
              containerClassName={`${grade.bgColor} rounded-3xl overflow-hidden`}
              colors={grade.colors || [[125, 211, 252]]}
              dotSize={grade.dotSize || 2}
            />
          </Card>
        ))}
      </div>
      ...
      <div className="my-20 flex flex-wrap items-center justify-center w-full gap-4">
        <div className="flex flex-col lg:flex-row gap-4 w-full lg:w-auto">
          ...
          <Card
            ...
            icon={<AceternityIcon grade="HPLC" />}
        ...
        <div className="flex flex-col lg:flex-row gap-4 w-full lg:w-auto">
          <Card
            ...
            icon={<AceternityIcon grade="LCMS" />}
          ...
          <Card
            title="Peptide Synthesis & DNA Synthesis"
            icon={<AceternityIcon grade="PTS-DS" />}
            desc="This is where the magic happens! Based on the approved design, 
            I'll translate everything into functional code, building your website
            from the ground up."
          >
...
const AceternityIcon = ({ grade }: { grade: string }) => {
  return (
    <div>
